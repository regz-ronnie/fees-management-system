         ...
         <div class="row ">
                ...
                <div class="col-md-4 col-md-offset-4 col-sm-6 col-sm-offset-3 col-xs-10 col-xs-offset-1">
                            ...
                            <div class="panel-body" style="background-color: #E2E2E2; margin-top:50px; border:solid 3px #0e0e0e;">
							  <h3 class="myhead">Bidii High School Fees Payment System</h3>
                                <form role="form" action="login.php" method="post">
                                    ...
                                    <div class="form-group">
                                     ...
                                     <button class="btn btn-primary" type= "submit" name="login">Login Now</button><br><br>
                                     <button><div class="form-group">

                                             <span class="pull-right">
                                                    <a href="loginparent.php" >Parent ? Click Here </a>
                                             </span>
                                      </div></button>
                                    </form>
                            </div>
